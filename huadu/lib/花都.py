...
class Spider(Spider):
    ...
    def gethost(self):
        ...
        self.headers.update({'referer': 'https://hd18.huaduziyuan.net/'})
        response = self.session.get('https://hd18.huaduziyuan.net/js/config.js',proxies=self.proxies,params=params,headers=self.headers)
